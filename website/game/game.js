...
PIXI.loader
  .add(["tongue.png", "frog.png", "lilypad.png", "flyone.png", "flytwo.png", "pond.png", "background.png"])
  .load(setup);
//setup();
/*
function loadSounds() {
...
function setup() {
    ...
    */
    ...
    pond = new Sprite(resources["pond.png"].texture);
    pond.x = 0;
    pond.y = 0;

    frog = new Sprite(resources["frog.png"].texture);
    frog.scale.x = 0.10;
    frog.scale.y = 0.10;
    frog.anchor.x = 0.5;
    frog.x = 187.5;
    ...
    lilypad = new Sprite(resources["lilypad.png"].texture);
    ...
    */
    var flyImages = ["flyone.png", "flytwo.png"];
    var textureArray = [];
    ...
    tongue = new Sprite(resources["tongue.png"].texture);
    tongue.scale.x = 0.80;
    tongue.scale.y = 0.80;
